      ...
      children: <Widget>[
        ...
        new ListTile(
          ...
          onTap: () {
            ...
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => AboutClass()));
          },
        ),
          ...
          children: <Widget>[
            ...
            IconButton(
              ...
              onPressed: () async {
                ...
                const url =
                    "https://www.facebook.com/profile.php?id=100004353226781";

                // to webView
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => View(url, "Facebook")));
              },
            ),
            ...
            IconButton(
              icon:
                  Icon(FontAwesomeIcons.instagram, color: Colors.purpleAccent),
              onPressed: () async {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => View(url, "Instagram")));
              },
            ),
            ...
            IconButton(
              ...
              onPressed: () async {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => View(url, "Twitter")));
              },
            ),
            ...
            IconButton(
              ...
              onPressed: () async {
                ...
                const url =
                    "https://www.linkedin.com/in/aditya-kanikdaley-471452190/";

                // to webView
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => View(url, "LinkedIn")));
              },
            ),
          ],
        ),
