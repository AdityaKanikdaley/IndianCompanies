      ...
      child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              image:
                  DecorationImage(image: AssetImage("assets/headLogo/me.jpg"))),
        ),
      ),
    );

    final aboutMe = Container(
        child: Wrap(
      alignment: WrapAlignment.spaceBetween,
      direction: Axis.horizontal,
      children: <Widget>[
        Text(
          "This app is mainly made to show that India is becoming much 'self-reliant India' or 'self-sufficient'. \n"
          "This term was used by the Prime Minister of India Narendra Modi in relation to economic development in country.\n",
          style: TextStyle(fontSize: 16, color: Colors.black),
        ),
        Text(
          "The five pillars of ‘Atmanirbhar Bharat’ he stated as economy, infrastructure, technology, vibrant demography"
          " and demand and asked the nation of 1.3 billion people diligently to be vocal for local, PM said.\n",
          style: TextStyle(fontSize: 15, color: Colors.black),
        ),
        Text(
          "Therefore, be Proud to be an INDIAN\n",
          style: TextStyle(
              fontWeight: FontWeight.bold, fontSize: 14, color: Colors.black),
        ),
        Text(
          "This app can also be used as a \"SHORTCUT MANAGER\" to visit the Company's Website\n",
          style: TextStyle(
              fontWeight: FontWeight.bold, fontSize: 12, color: Colors.black),
        ),
        Text(
          "Development of this app is been done by: \nAditya Kanikdaley,\nFor any queries and suggestions, mail me on:",
        ...
        InkWell(
            ...
            child: Text("adikanikdaley@gmail.com\n\n",
                style: TextStyle(
                    color: Colors.blue, letterSpacing: 1, fontSize: 14))),
        Align(
            ...
            child: TextButton(
              onPressed: () async {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => View(url, "Atmanirbhar Bharat")));
              },
